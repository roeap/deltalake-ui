...
class FloatScalar(Scalar):
    def as_py(self) -> float: ...

class Array:
    """The base class for all Arrow arrays."""

    def cast(self, target_type: DataType, safe: bool = True, options=None) -> Array:
...
class RecordBatchReader:
    ...
    def from_batches(self, schema: Schema, batches: Iterable[RecordBatch]):
